<div class="sidebar bg-white drop-shadow-xl w-64 fixed top-0 h-screen">
    ...
    <ul>
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'dashboard') echo 'active' ?> " href="./doctor-interfaces/doctor-dashboard.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'my_appointment') echo 'active' ?> " href="./doctor-interfaces/doctor-my-appointments.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'my_sessions') echo 'active' ?>" href="./doctor-interfaces/doctor-my-sessions.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'my_patients') echo 'active' ?>" href="./doctor-interfaces/doctor-my-patients.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'settings') echo 'active' ?> " href="./doctor-interfaces/doctor-settings.php">
