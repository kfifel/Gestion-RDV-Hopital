<div class="sidebar bg-white drop-shadow-xl w-64 fixed top-0 h-screen">
    ...
    <ul>
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'settings') echo 'active' ?> " href="./">
