...
<div class="sidebar bg-white drop-shadow-xl w-64 fixed top-0 h-screen">
    ...
    <ul>
        <li class="">
            <a class="side-link flex items-center pl-12  p-5 <?php if($GLOBALS['current_page'] == 'dashboard') echo 'active' ?>" href="./admin-interfaces/admin-dashboard.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'doctors') echo 'active' ?>" href="./admin-interfaces/admin-doctors.php">
        ...
        <li class="">
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'schedule') echo 'active' ?>" href="./admin-interfaces/admin-schedule.php">
        ...
        <li class="">
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'appointment') echo 'active' ?>" href="./admin-interfaces/admin-appointment.php">
        ...
        <li class="">
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'patients') echo 'active' ?>" href="./admin-interfaces/admin-patients.php">
