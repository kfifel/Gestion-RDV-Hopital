<div class="sidebar bg-white drop-shadow-xl w-64 fixed top-0 h-screen">
    <div class="flex items-center justify-center gap-4 py-7">
        <img src="/assets/img/user.png" class="w-16 h-16 rounded-full" alt="">
        <div>
    ...
    <ul>
        <li class="">
            <a class="side-link flex items-center pl-12  p-5 active" href="">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5" href="">
