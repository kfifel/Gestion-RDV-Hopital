<div class="sidebar bg-white drop-shadow-xl w-64 fixed top-0 h-screen">
    ...
    <ul>
        <li class="">
            <a class="side-link flex items-center pl-12  p-5 <?php if($GLOBALS['current_page'] == 'home') echo 'active' ?>" href="./patient-interfaces/patient-home.php">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#3b3b3b"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 5.69l5 4.5V18h-2v-6H9v6H7v-7.81l5-4.5M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3z"/></svg>    
                <span class="pl-2">Home</span>
            </a>
        </li>
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'all_doctors') echo 'active' ?>" href="./patient-interfaces/patient-all-doctors.php">
                ...
                <span class="pl-2">All Doctors</span>
            </a>
        </li>
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'scheduled_sessions') echo 'active' ?>" href="./patient-interfaces/patient-scheduled-sessions.php">
                ...
                <span class="pl-2">Scheduled Sessions</span>
            </a>
        </li>
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'my_bookings') echo 'active' ?>" href="./patient-interfaces/patient-my-bookings.php">
                ...
                <span class="pl-2">My Bookings</span>    
            </a>
        </li>
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'settings') echo 'active' ?>" href="./patient-interfaces/patient-settings.php">
