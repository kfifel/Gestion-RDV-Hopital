<div class="sidebar bg-white drop-shadow-xl w-64 fixed top-0 h-screen">
    ...
    <ul>
        <li class="">
            <a class="side-link flex items-center pl-12  p-5 <?php if($GLOBALS['current_page'] == 'home') echo 'active' ?>" href="./patient-home.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'all_doctors') echo 'active' ?>" href="./patient-all-doctors.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'scheduled_sessions') echo 'active' ?>" href="./patient-scheduled-sessions.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'my_bookings') echo 'active' ?>" href="./patient-my-bookings.php">
        ...
        <li>
            <a class="side-link flex items-center pl-12 p-5 <?php if($GLOBALS['current_page'] == 'settings') echo 'active' ?>" href="./patient-settings.php">
