...
<!-- <div id="editdoctormodal" tabindex="-1"  class="fixed p-1 left-0 right-0 z-50 hidden w-full overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full"> -->
                                    ...
                                    <div class="min-h-screen   flex flex-col justify-center ">
                                        ...
                                        <div
                                            ...
                                            <div class="relative   bg-white shadow-lg rounded-3xl sm:p-20">
                                                ...
                                                <div>
                                                        <h1 class=" flex justify-center text-2xl font-semibold">Edit Doctor </h1>
                                                    </div>
                                                    <div>
